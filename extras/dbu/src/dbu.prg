...
PROCEDURE Dbu( param1, param2, param3 )
   ...
   ***
   ...
   // start. --Pete D. 17/03/2019
   // add mouse support (currently of no use, for future use perhaps). 
   MSETCURSOR ( .T. )
   SET ( _SET_EVENTMASK, INKEY_ALL )
   // extend display mode: nowadays monitors have a lot viewing space...
   SetMode( 43, 132 )
   // end. --Pete D. 17/03/2019
